...
const team = [
  {
    ...
    bio: "Full-stack architect who has shipped 120+ products across web and mobile.",
  },
  {
    name: "Ananya Rao",
    ...
    bio: "Designs interfaces that feel alive — motion, color and typography done right.",
  },
  {
    name: "Ravi Kumar",
    ...
    bio: "Turns audiences into customers with data-driven campaigns and SEO.",
  },
  {
    name: "Meera Iyer",
    role: "Mobile Lead",
    ...
    bio: "Crafts native-feel mobile experiences users genuinely love to open.",
  },
];
